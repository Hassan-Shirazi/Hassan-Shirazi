...
Here are a few projects I've worked on. Check them out on my Github & Live Preview!

| Project Name                                                   | Description                                  |
| -------------------------------------------------------------- | -------------------------------------------- |
| 🔗 [**Tic Tac Toe**](https://hassan-shirazi.github.io/Tic-Tac-Toe-Game/)      | Play a Tac tac toe game with Robot.   |
| 🔗 [**Rock Paper Scissors**](https://hassan-shirazi.github.io/Rock-Paper-Scissors-Game/)      | Play a Rock Paper Scissore game with Robot.    |
| 🔗 [**Memory Card Game**](https://hassan-shirazi.github.io/Memory-Card-Game/)      | Play a Memory Card Game with Emojis.   |
| 🔗 [**Calculator App**](https://hassan-shirazi.github.io/Calculator-App/)      | calculator web app with all operators.   |
| 🔗 [**Todo App list**](https://hassan-shirazi.github.io/To-do-App-List/)      | TODO app list with Delete active and edit.   |
| 🔗 [**Real Time Clock**](https://hassan-shirazi.github.io/Real-Time-Clock/)      | Real Time clock app in circle design and numbers.   |
| 🔗 [**Text to Speech**](https://hassan-shirazi.github.io/Text-To-Voice-/)      | Write Something in input and click on mic then see magic.   |
| 🔗 [**Furniture Website**](https://hassan-shirazi.github.io/Furniture-Website/)       | A sleek website for a Home Furniture.   |
| 🔗 [**Clothes Website**](https://hassan-shirazi.github.io/Clothes-Website/)      | A sleek website for Online Clothes.   |
...
<p align="center">
  ...
  <a href="https://www.linkedin.com/in/hassan-shirazi-67559834a/" target="_blank">
